...
def migrate(api_source, api_target, workspaces_map):
    ...
    for workspace_id in workspaces_map:
        ...
        # NOTE: it seems that the notification configuration endpoints will not
        # throw an error if you try to create one with a duplicate name. This is
        # because a workspace can have up to 20 of them.
