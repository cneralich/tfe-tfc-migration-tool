...
def delete_all(api_target):
    print("Deleting policy set params...")
    ...
    if policy_sets:
        for policy_set in policy_sets:
            ...
            for param in params:
                print(f"\t deleting policy set param %s..." % param["attributes"]["key"])
                api_target.policy_set_params.destroy(policy_set["id"], param["id"])

    print("Policy set params deleted.")